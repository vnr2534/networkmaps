...
function fill_default_settings(initial_settings) {
    let settings = {
        ...
        users: {
            ...
            allowed_domains: [],
            register_self: true,
            path: "C:/networkmaps/lib/networkmaps/users",
        ...
        diagrams: {
            path: "C:/networkmaps/lib/networkmaps/diagrams",
            shapes: "C:/networkmaps/lib/networkmaps/shapes",
        },
        sendmail: {
            queue: "C:/networkmaps/lib/networkmaps/sendmail/queue",
            sent: "C:/networkmaps/lib/networkmaps/sendmail/sent",
            server: "",
            port: "",
            is_secured: false,
...
function load() {
    ...
    let path = 'C:/networkmaps/config.json';
